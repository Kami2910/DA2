...
if (isset($_POST['update-duan']))
{
  ...
  $update_phancong = $conn->QUERY("UPDATE phancong SET PC_HanChot = '$hanchot'  WHERE PC_MaDuAn = '$maduan'");
...
if (isset($_POST['themcv'])) {
  ...
  if($timeCV<=$timeDA) {
    ...
    if($tenCV!="" && $maCV!="" && $themhanchot!=""){

    $themcongviec = $conn->query("INSERT INTO congviec (`CV_MaCongViec`, `CV_TenCongViec`) VALUES ('$maCV','$tenCV')");
    $themcongviec2 = $conn->query("INSERT INTO phancong(PC_MaDuAn, PC_MaCongViec, PC_HanChot)
                                   VALUES ('$id','$maCV','$themhanchot')");
    ...
    if ($themcongviec && $themcongviec2) {
      ...
      echo "<script> alert ('Nhập đủ thông tin') </script>";
      echo "<script>
      location.href = './QLDA_PTN.php?id=$id';
    </script>";
            ...
            <div class="right-text">
              ...
              <table class="table table-bordered" id="TTCN" width="100%" cellspacing="100%">
                ...
                <?php while($rowCV = $thongtincongviec->fetch_assoc()){
                  ...
                  $thongtincanhan = $conn->query("SELECT * FROM thongtincanhan WHERE TTCN_MaTTCN = '$mattcn'");
                ...
                ?>
                  ...
                  ?></th>                  <th><?php echo $rowCV['PC_MaVaiTro']?></th>
            ...
            <table class="table table-bordered" id="TTCN" width="100%" cellspacing="100%" style=" position:relative;top:50px;  ">
                ...
                ?>
                  ...
                  <th><button style="height: 40px; width: 90px; font-size: 12px; margin-right: 5px; color: #000;" type="submit" name="xong" class="btn btn-success" value="Đã xong">
                                                    <a style="color: #fff" href="./QLDA_PTN.php?action=xong&id=<?php echo $rowcv['DA_MaDuAn'];?>&cv=<?php echo $rowcv['PC_MaCongViec']?>&mattcn=<?php echo $rowcv['PC_MaTTCN']?>">Đã xong</a>
                      </button>
                    </th>
                </tr>
                <?php  }?>
              ...
              <table class="table table-bordered" id="TTCN" width="100%" cellspacing="100%">
                ...
                ?>
                 <td>
                  ...
                  <th><a href="./binhluanPTN.php?id=<?php echo $_GET['id']?>&cv=<?php echo $row['CV_MaCongViec'] ?>">Bình luận</a></th>
</tr>
              <?php $STT+=1;
                    endwhile?>
              </table>
