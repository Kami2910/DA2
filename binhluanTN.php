      ...
      <div class="container">
            ...
            <div class="right-text">
              ...
              <table class="table table-bordered" id="TTCN" width="100%" cellspacing="100%">
                ...
                WHERE PC_MaDuAn = '$maduan'  AND BL_MaCongViec = '$macv' AND TTCN__TenDN = '$dulieunhan'");
                ...
                $row1 = $sqli->fetch_assoc();
                    ...
                    while ($row = $sql->fetch_assoc()):
                        ...
                        $sqli3 = $conn->query("SELECT VT_TenVaiTro, TTCN__TenDN FROM phancong pc
                                            join vaitro vt on pc.PC_MaVaiTro =  vt.VT_MaVaiTro  
                                            join thongtincanhan ttcn on pc.PC_MaTTCN = ttcn.TTCN_MaTTCN
                                            WHERE PC_MaTTCN = '$matv' AND PC_MaDuAn = '$maduan'");
                ...
                ?>
                 <td>
                  ...
                  <th><?php echo $row3['TTCN__TenDN']?></th>
